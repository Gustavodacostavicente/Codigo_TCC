...
#%%
model = Sequential()
model.add(LSTM(units=100, activation="sigmoid", input_shape=(Valor_Entrada.shape[1],Valor_Entrada.shape[2])))
model.add(LSTM(units=100, activation="sigmoid"))
model.add(LSTM(units=100, activation="sigmoid"))
model.add(LSTM(units=1,activation="sigmoid"))# Bloco neural final
